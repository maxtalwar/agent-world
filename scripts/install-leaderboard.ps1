...
for module in ["leaderboard.py", "leaderboard_launch.py", "leaderboard_supervisor.py", "leaderboard_models.py", "leaderboard_event_monitor.py", "benchmark_acceptance.py", "capability_reanalysis.py", "gemini_pricing.py", "astra_pricing.py", "world_viewer.py"]:
