...
class LaunchCheckoutTests(unittest.TestCase):
    ...
    def test_pinned_package_extracts_only_the_package_once(self):
        from agent_world.leaderboard_launch import pinned_package
        target = pinned_package(self.root, self.commit)
        ...
        self.assertTrue((pinned_package(self.root, self.commit) / "agent_world/marker").exists())
        with self.assertRaises(ValueError):
            pinned_package(self.root, "HEAD")
