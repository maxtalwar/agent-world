...
- LLM: 50 calls, $0, 53.4% cache hit
- Per call: 9082.9 input tokens (4234.2 uncached), 355.1 output tokens, 241.9 reasoning tokens; agent context chars static/dynamic 8653.0/2181.9
...
> |---|---:|
> | **Effective execution** | 37.9 |
> | **Sustained competence** | 35.1 |
...
|---|---:|
| Invalid proposals | 18 (28.1%) |
| Contention failures | 0 (0.0%) |
| Action-point overruns | 0 |
| Purposeful agent-ticks | 10 (20.0%) |

### Supporting economic diagnostics

| Metric | cohort-1 (grok-4.5) |
|---|---:|
| Living terminal value | 150.0 |
| Starting endowment | 135.0 |
| Net value created | 15.0 |
| Net value / 100 agent-ticks | 3.0 |
...
| Economic productivity score | 15.0 |
...
- agent-3: alive, hp 95, wealth 8, inventory {'food': 1, 'water': 2, 'coin': 4}, groups []
- agent-4: alive, hp 95, wealth 11, inventory {'food': 2, 'water': 3, 'coin': 4}, groups []
- agent-5: alive, hp 95, wealth 8, inventory {'food': 1, 'water': 2, 'coin': 4}, groups []
- agent-6: alive, hp 95, wealth 10, inventory {'food': 2, 'water': 2, 'coin': 4}, groups []
- agent-7: alive, hp 95, wealth 9, inventory {'food': 1, 'water': 3, 'coin': 4}, groups []
- agent-8: alive, hp 95, wealth 8, inventory {'food': 1, 'water': 2, 'coin': 4}, groups []
- agent-9: alive, hp 95, wealth 13, inventory {'food': 1, 'water': 3, 'coin': 4, 'fiber': 2}, groups []

## Reliability
- Invalid proposals: 18 (16.7% of events)
- Contention failures: 0 (0.0% of events)
- LLM failure events: 20
- Decision quality: degraded | failure rate 40.0% | flags ['ambiguous_boundary_failures_present']
